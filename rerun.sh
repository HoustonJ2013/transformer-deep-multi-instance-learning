...
#python tdmil/eval.py --checkpoint_path model_weights/property_img_transformer_numpygenerator/ --inp_csv  datasets/train_image_emb.csv --num_rerun 3
#python tdmil/eval.py --checkpoint_path model_weights/property_img_transformer_numpygenerator/ --inp_csv  datasets/val_image_emb.csv --num_rerun 3
